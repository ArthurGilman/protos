...
const (
	GrpcServer_GetUser_FullMethodName = "/grpc.GrpcServer/GetUser"
)
...
type GrpcServerClient interface {
	GetUser(ctx context.Context, in *GetAllUsersRequest, opts ...grpc.CallOption) (*GetUsersResponse, error)
}
...
func (c *grpcServerClient) GetUser(ctx context.Context, in *GetAllUsersRequest, opts ...grpc.CallOption) (*GetUsersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUsersResponse)
	err := c.cc.Invoke(ctx, GrpcServer_GetUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GrpcServerServer interface {
	GetUser(context.Context, *GetAllUsersRequest) (*GetUsersResponse, error)
...
func (UnimplementedGrpcServerServer) GetUser(context.Context, *GetAllUsersRequest) (*GetUsersResponse, error) {
...
func _GrpcServer_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAllUsersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GrpcServerServer).GetUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GrpcServer_GetUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GrpcServerServer).GetUser(ctx, req.(*GetAllUsersRequest))
	}
...
var GrpcServer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.GrpcServer",
	HandlerType: (*GrpcServerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetUser",
			Handler:    _GrpcServer_GetUser_Handler,
		},
	},
